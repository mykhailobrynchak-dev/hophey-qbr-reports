#!/usr/bin/env python3
"""Generate HOP HEY QBR Report (index.html) from Databricks.
...
Outputs a single self-contained index.html with two tabs: Monthly / Weekly.
"""
...
# Acceptance / Availability uses the provider weekly fact table with proper weighting
...
WHERE p.country_code = 'ua'
  ...
  AND f.order_created_date >= '{DATA_START}'
GROUP BY 1, 2, 3
ORDER BY 1, merchant_price_eur DESC
"""
